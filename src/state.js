...
export const TOGGLE_SETTING_DEFAULTS = Object.freeze({
    ...
    keepPersonaCharacter: false,
    persistPersonaColor: false,
    keepCardCharacter: true,
    clearUnpinnedOnNewChat: false,
